...
public class L7{
    ...
    public static void main(String[] args){
        ...
        System.out.println("The money I have is" + currency.format(27346786.782364));

        DecimalFormat percentage = new DecimalFormat ("##%");
        System.out.println("Sales tax is : " + percentage.format(0.07));

        DecimalFormat crazy = new DecimalFormat("THIS IS JUST LOTS MONEY $#,###.00");
        System.out.println(crazy.format(123456789.234567));
    }
}
